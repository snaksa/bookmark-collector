...
import {
    ...
    initializedArchivedBookmarks, addToFavoritesBookmark, removeFromFavoritesBookmark,
} from "../../../../redux/bookmarks/bookmarks.actions";
import {useDispatch, useSelector} from "react-redux";

export default function ArchivedScreen() {
    const {fetch: fetchBookmarks} = useHttpGet('bookmarks', {archived: 1}, true);
    ...
    return <Container>
        ...
        {archived.isLoading ? <Box>Loading...</Box> : <BookmarksList bookmarks={archived.data} onDelete={onDelete} onFavoriteUpdate={onFavoriteUpdate} onArchivedUpdate={onArchivedUpdate} />}
    </Container>;
